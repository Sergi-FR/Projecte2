...
public class Activitat {
    ...
    public ArrayList<Activitat> visalitzaActivitats(){
        ...
        String consulta = "SELECT A.*,count(R.dni) FROM reserva R right join activitats A on R.id_act = A.ID_Act GROUP BY R.ID_Act WHERE R.data= curdate() ORDER BY count(R.DNI) desc";
